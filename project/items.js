var items_296f5d02_12fd_4166_a7c1_b5e830c9ee3a = 
{
	"items": {
		...
		"superPotion": {
			"cls": "constants",
			"name": "提交摸牌战记录",
			"text": "当前摸牌战胜场记录为${(flag:胜场记录)}，点击可提交该记录"
		},
		"moneyPocket": {
			"cls": "items",
			"name": "金钱袋"
	...
	"useItemEffect": {
		"book": "if (flags[\"卡选\"] >= 1)\n\tcore.drawTip(\"选卡中不能进行该操作\");\nelse\n\tcore.insertAction(\"老人左\");",
		...
		"redJewel": "if (flags[\"卡选\"] >= 1)\n\tcore.drawTip(\"选卡中不能进行该操作\");\nelse\n\tcore.insertAction(\"老人右\");",
		...
		"coin": "if (flags[\"卡选\"] >= 1)\n\tcore.drawTip(\"选卡中不能进行该操作\");\nelse\n\tcore.insertAction(\"老人左\");",
		"wand": "core.insertAction(\"提交\")",
		"I321": "core.insertAction(\"技能图片\")",
		"superPotion": "core.insertAction(\"提交2\")"
	},
	"canUseItemEffect": {
		"book": "true",
